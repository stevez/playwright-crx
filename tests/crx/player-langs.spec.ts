...
const langs = {
  'javascript': { line: `  await page.locator('textarea').click();`, linenumber: 8 },
  'playwright-test': { line: `  await page.locator('textarea').click();`, linenumber: 5 },
  'java': { line: `      page.locator("textarea").click();`, linenumber: 13 },
  ...
  'csharp': { line: `        await page.Locator("textarea").ClickAsync();`, linenumber: 11 },
};
