...
import { ContextRecorder } from './recorder/contextRecorder';
...
import type { SourceHighlight } from '@recorder/recorderTypes';
...
export class Recorder extends EventEmitter<RecorderEventMap> implements InstrumentationListener {
  ...
  private _pushAllSources() {
    this.emit(RecorderEvent.UserSourcesChanged, [...this._recorderSources, ...this._userSources.values()], this.pausedSourceId());
  }
